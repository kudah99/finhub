    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('business_owner', models.BooleanField(blank=True, null=True, verbose_name='business owner')),
                ('income_per_month', models.CharField(max_length=50, null=True)),
                ('type_of_business', models.CharField(max_length=50, null=True)),
                ('date_of_establishment', models.DateField(null=True, verbose_name='date of establishemnt')),
